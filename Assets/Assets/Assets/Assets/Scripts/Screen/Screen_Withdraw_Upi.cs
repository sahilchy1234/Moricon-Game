...
{
    public class Screen_Withdraw_Upi : ISCREEN
    {
        [Space]
        ...
        private void OnClick_Withdraw()
        {
         //  AdsManager.instance.Show_Rewarded(() =>
           //  {
            ...
            ApiManager.instance.API_PayoutRequestAmazonPay(inpt_amount.text, 1, () =>
              {
               ...
               () =>
               {
                   Toast.ShowToast("Withdrawal limit reached,come tomorrow");
               });
