...
{
    public class Screen_Connecting : ISCREEN
    {
        [Space(20)]
        ...
        public PlayerInfoNew[] playerInfos;
     ...
     //  [SerializeField] float botAdd_TimeLeft;
        ...
        public void StartGameOnDeposit()
        {
          //  Toast.ShowToast("Amount deducted! Please do not leave the game");
            ...
            ApiManager.instance.API_MinusWallet("Game Entry Fee", AppManager.instance.Get_BattleSettings().amount, 2,
                () =>
                {
                    Toast.ShowToast("Amount deducted! Please do not leave the game");
